...
familiar with ArchGuard to understand, and for somebody familiar with the
...
- the impact on teaching people ArchGuard
- integration of this feature with other existing and planned features
- cost of migrating existing ArchGuard applications (is it a breaking change?)
...
If we implement this proposal, how will existing ArchGuard developers adopt it? Is
